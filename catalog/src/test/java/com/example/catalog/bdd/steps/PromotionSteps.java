...
public class PromotionSteps {
    ...
    public void endPromotionDueToExpiredDate(Date currentDate, String productId, boolean eligibleForPromo, double discountToDiscard, Date expirationDate){
        String payload = String.format("{\"productId\":\"%s\", \"discount\":%f, \"eligibleForPromo\":%b}", productId, discountToDiscard, eligibleForPromo);
